...
import { Home, FilePlus, BookText, ListChecks } from 'lucide-react';
import './globals.css';
...
const navItems = [
  ...
  { href: '/analyses', label: '분석 목록', Icon: ListChecks },
  { href: '/analyses/new', label: '새 분석', Icon: FilePlus },
  { href: '/guidelines', label: '가이드라인', Icon: BookText },
];
